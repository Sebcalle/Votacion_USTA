...
urlpatterns = [
    ...
    path('listaDeEstudiantesPostular/<int:id_votacion>/', views.listaDeEstudiantesPostular, name='listaDeEstudiantesPostular'),
    ...
    path('postulacionExitosaDecano/<int:id_votacion>/<int:id_usuario>/',views.postulacionExitosaDecano, name='postulacionExitosaDecano'),
    # estudiante
